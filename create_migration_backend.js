...
const targetPath = 'c:\\Projects\\student-marketplace-backend-v2\\migrations\\20260218120000_create_countries.js';
try {
    fs.writeFileSync(targetPath, content);
    console.log('Migration updated at ' + targetPath);
} catch (err) {
    console.error('Failed to write migration:', err);
}
