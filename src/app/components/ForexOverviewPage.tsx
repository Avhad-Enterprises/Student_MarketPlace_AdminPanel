...
export const ForexOverviewPage: React.FC<ForexOverviewPageProps> = ({ onNavigate }) => {
  ...
  return (<TooltipProvider><div suppressHydrationWarning className="flex-1 overflow-y-auto p-4 md:p-8 custom-scrollbar-light">
      ...
      <div className="hidden md:block overflow-auto custom-scrollbar-light max-h-[600px]">
        {isLoading ? (
          ...
          <div className="p-12 text-center text-gray-400">
            <p className="text-lg font-medium">No forex providers found</p>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent className="w-40" align="end">
                        <DropdownMenuItem className="flex items-center gap-2" onClick={() => onNavigate?.('forex-provider-detail', { forexId: item.id })}><Eye size={16} className="text-gray-400" />View</DropdownMenuItem>
                        <DropdownMenuItem className="flex items-center gap-2" onClick={() => handleEditForex(item)}><Edit size={16} className="text-gray-400" />Edit</DropdownMenuItem>
