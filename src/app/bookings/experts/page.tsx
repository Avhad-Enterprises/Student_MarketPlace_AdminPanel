        ...
        <AdminLayout activePage="bookings-experts">
            <div className="py-6">
                <div className="mb-8">
                    ...
                    <p className="text-gray-500 mt-2">Manage expert assignments and counselor workloads.</p>
                </div>
                ...
                <div className="bg-white rounded-[32px] p-12 border border-gray-100 shadow-xl shadow-indigo-900/5 flex flex-col items-center justify-center text-center">
                    ...
                    <h2 className="text-2xl font-bold text-[#0e042f] mb-3">Expert Management</h2>
                    <p className="text-gray-500 max-w-md">
                        This module is currently being implemented. Soon you'll be able to assign leads to specific counselors and experts.
                    </p>
                </div>
            </div>
        </AdminLayout>
